...
<div class="mt-6 filament-companies-socialite">
    ...
    <div class="filament-companies-socialite-button-container mt-6 flex flex-wrap items-center justify-center gap-6">
        @foreach (\TFSThiagoBR98\FilamentTenant\Enums\Provider::cases() as $provider)
            @if ($provider->isEnabled())
                <a href="{{ \TFSThiagoBR98\FilamentTenant\FilamentCompanies::generateOAuthRedirectUrl($provider->value) }}"
